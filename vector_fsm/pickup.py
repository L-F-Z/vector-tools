...
from .vector_kin import center_of_rotation_offset
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        """
            ...
            satisfied: AnimationTriggerNode(trigger=vector.anim.Triggers.ReactToBlockPickupSuccess,
            ...
            frustrated: StateNode() =N=> AnimationTriggerNode(trigger=vector.anim.Triggers.FrustratedByFailure,
                                             ignore_body_track=True,
                                             ignore_head_track=True,
        ...
        animationtriggernode1 = AnimationTriggerNode(trigger=vector.anim.Triggers.FrustratedByFailure,
                                         ignore_body_track=True,
                                         ignore_head_track=True,
