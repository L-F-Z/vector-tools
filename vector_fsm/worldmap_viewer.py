"""
OpenGL world viewer for vector_fsm world map.
"""
...
class WorldMapViewer():
    ...
    def make_custom_cube(self,custom_obj,obst):
        ...
        if isinstance(custom_obj, vector.objects.CustomObject):
    ...
    def make_foreign_robot(self,obj):
        ...
        glTranslatef(*( 0,  0,   36))
        glScalef(0.25, 0.2, 0.25)
        glutStrokeCharacter(GLUT_STROKE_MONO_ROMAN, ord(ascii(obj.vector_id%9)))
        glPopMatrix()
