"""
  ...
  This version is coded using the vector_fsm package and illustrates
...
class HeadAndLiftGesture(StateNode):
    ...
    def setup(self):
        """
            ...
            move_head: SetHeadAngle(vector.robot.MAX_HEAD_ANGLE)
        ...
        move_head = SetHeadAngle(vector.robot.MAX_HEAD_ANGLE) .set_name("move_head") .set_parent(self)
    ...
    def setup(self):
        """
            ...
            player_appears: WaitForPlayer()
                ...
                =C=> SetHeadAngle(vector.robot.MIN_HEAD_ANGLE)
                =C=> SetHeadAngle(vector.robot.MAX_HEAD_ANGLE)
                =C=> player_hides
        ...
        setheadangle2 = SetHeadAngle(vector.robot.MIN_HEAD_ANGLE) .set_name("setheadangle2") .set_parent(self)
        setheadangle3 = SetHeadAngle(vector.robot.MAX_HEAD_ANGLE) .set_name("setheadangle3") .set_parent(self)
